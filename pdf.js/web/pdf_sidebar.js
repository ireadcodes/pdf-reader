...
class PDFSidebar {
  ...
  switchView(view, forceOpen = false) {
    ...
    const isThumbs = view === SidebarView.THUMBS,
      ...
      isAnnotations = view === SidebarView.ANNOTATIONS;
    ...
    this.annotationsButton.classList.toggle("toggled", isAnnotations);

    this.thumbnailButton.setAttribute("aria-checked", isThumbs);
    this.outlineButton.setAttribute("aria-checked", isOutline);
    this.attachmentsButton.setAttribute("aria-checked", isAttachments);
    this.layersButton.setAttribute("aria-checked", isLayers);
    this.annotationsButton.setAttribute("aria-checked", isAnnotations);
    // ... and for all views.
    this.thumbnailView.classList.toggle("hidden", !isThumbs);
    this.outlineView.classList.toggle("hidden", !isOutline);
    this.attachmentsView.classList.toggle("hidden", !isAttachments);
    this.layersView.classList.toggle("hidden", !isLayers);
    this.annotationsView.classList.toggle("hidden", !isAnnotations);
